...
app.use(VueFinder, {
  ...
  i18n: {
    ...
    es: async () => await import('../src/locales/es.js'),
    it: async () => await import('../src/locales/it.js'), 
    ja: async () => await import('../src/locales/ja.js'),
    pt: async () => await import('../src/locales/pt.js'),
